...
textures = ["materials/floor.png", 'materials/door2.png', 'materials/door3.png', 'materials/door5.png',
            'materials/door6.png', 'materials/door7.png', 'materials/door8.png', 'materials/door10.png'
            ,'materials/door4.png', 'materials/green_exit2.png']
...
def start():
    ...
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (33, 1))
    ar3 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (31, 0))
    door1 = Sc.Sprite(textures[8], (2450, 20), (355, 605))
    door2 = Sc.Sprite(textures[7], (1730, 40), (250, 560))
    door3 = Sc.Sprite(textures[4], (135, 50), (265, 555))
    door4 = Sc.Sprite(textures[1], (825, -45), (535, 700))
    grex = Sc.Sprite(textures[9], (1425, 10), (95, 95))
