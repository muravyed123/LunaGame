...
def start():
    ...
    ar1 = Sc.Area(1945, 65, (40, 625), Sc.change_scene, (6, 1))
    colis1 = Sc.CollisionShape(-80, 160, (85, 625))
    door1 = Sc.Sprite(textures[1], (540, -60), (565, 710))
    door2 = Sc.Sprite(textures[2], (180, 20), (335, 605))
    door3 = Sc.Sprite(textures[1], (1245, -60), (560, 710))
