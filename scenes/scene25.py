...
def start():
    ...
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (21, 1))
    colis1 = Sc.CollisionShape(2970, 180, (100, 510))
    door1 = Sc.Sprite(textures[2], (1645, 20), (310, 615))
    door2 = Sc.Sprite(textures[6], (2365, 55), (335, 555))
    door3 = Sc.Sprite(textures[1], (60, -35), (555, 690))
    door4 = Sc.Sprite(textures[5], (930, 55), (285, 565))
