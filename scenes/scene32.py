...
def start():
    ...
    ar1 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (30, 0))
    ar2 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (36, 1))
    door1 = Sc.Sprite(textures[1], (915, -35), (540, 690))
    door2 = Sc.Sprite(textures[4], (230, 50), (290, 550))
    door3 = Sc.Sprite(textures[3], (2545, 40), (325, 560))
