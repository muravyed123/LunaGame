...
def start():
    ...
    objects.append(wall)
    objects.append(bord)
    label = Sc.PlayLabel('2 ЭТАЖ', (1180, 50), (100, 0, 0), 50)
    ...
    ar1 = Sc.Area(1685, 335, (160, 410), Sc.create_checktext,
                  ('Нажмите Т чтобы спуститься по ступеням', (1700, 400), G.BLACK, 50, pg.K_t, Sc.change_scene, (3, 1)),
                  Sc.delete_obj)
    ar4 = Sc.Area(1670, 335, (200, 410), Sc.create_checktext,
                  ('Нажмите R чтобы подняться по ступеням', (1700, 300), G.BLACK, 50, pg.K_r, Sc.change_scene, (21, 2)),
                  Sc.delete_obj)
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (9, 1))
    ar3 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (15, 0))
    door1 = Sc.Sprite(textures[1], (740, -30), (580, 680))
    door2 = Sc.Sprite(textures[2], (2280, 25), (320, 605))
    door3 = Sc.Sprite(textures[1], (5, -30), (585, 680))
