...
textures = ["materials/floor.png", 'materials/door2.png', 'materials/door3.png', 'materials/door5.png',
            'materials/door6.png', 'materials/stairs.png', 'materials/door7.png', 'materials/door10.png',
            'materials/evacuation.png']
...
def start():
    ...
    ar1 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (38, 0))
    ar2 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (30, 1))
    door1 = Sc.Sprite(textures[4], (1765, 60), (285, 540))
    door2 = Sc.Sprite(textures[7], (2570, 65), (270, 545))
    door3 = Sc.Sprite(textures[6], (210, 55), (300, 555))
    door4 = Sc.Sprite(textures[7], (995, 60), (270, 545))
    evac = Sc.Sprite(textures[8], (1425, 155), (255, 170))
