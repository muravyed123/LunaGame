...
def start():
    ...
    ar2 = Sc.Area(2925, 65, (40, 625), Sc.change_scene, (23, 0))
    colis1 = Sc.CollisionShape(-70, 180, (100, 510))
    door1 = Sc.Sprite(textures[3], (1575, 50), (340, 555))
    door2 = Sc.Sprite(textures[5], (2310, 50), (315, 565))
    door3 = Sc.Sprite(textures[2], (875, 15), (325, 615))
