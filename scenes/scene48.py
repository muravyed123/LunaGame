...
def start():
    ...
    ar2 = Sc.Area(2970, 65, (40, 625), Sc.change_scene, (44, 1))
    colis1 = Sc.CollisionShape(-70, 180, (100, 510))
    door1 = Sc.Sprite(textures[6], (2545, 45), (350, 565))
    door2 = Sc.Sprite(textures[2], (1095, 15), (335, 620))
    door3 = Sc.Sprite(textures[4], (1855, 55), (305, 555))
