...
textures = ["materials/floor.png", 'materials/door2.png', 'materials/door3.png', 'materials/door5.png',
            'materials/door6.png', 'materials/door7.png', 'materials/door8.png', 'materials/sinkroom.png',
...
def start():
    ...
    ar2 = Sc.Area(2970, 65, (40, 625), Sc.change_scene, (14, 1))
    colis1 = Sc.CollisionShape(-70, 180, (100, 510))
    door1 = Sc.Sprite(textures[1], (2455, -55), (595, 710))
    door2 = Sc.Sprite(textures[3], (1095, 35), (335, 565))
    door3 = Sc.Sprite(textures[5], (1905, 50), (305, 560))
    sink = Sc.Sprite(textures[7], (415, 45), (370, 555))
    window = Sc.Sprite(textures[8], (490, 205), (220, 125))
