...
def start():
    ...
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (13, 1))
    ar3 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (11, 0))
    door1 = Sc.Sprite(textures[3], (2630, 60), (315, 540))
    door2 = Sc.Sprite(textures[2], (1785, 25), (320, 605))
    door3 = Sc.Sprite(textures[5], (145, 50), (335, 560))
    door4 = Sc.Sprite(textures[3], (1000, 45), (330, 555))
