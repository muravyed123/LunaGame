...
def start():
    ...
    ar1 = Sc.Area(1075, 335, (170, 410), Sc.create_checktext,
                  ('Нажмите Т чтобы спуститься по ступеням', (1200, 400), G.BLACK, 50, pg.K_t, Sc.change_scene, (13, 2)),
                  Sc.delete_obj)
    ar4 = Sc.Area(1060, 335, (200, 410), Sc.create_checktext,
                  ('Нажмите R чтобы подняться по ступеням', (1200, 300), G.BLACK, 50, pg.K_r, Sc.change_scene, (33, 2)),
                  Sc.delete_obj)
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (27, 1))
    ar3 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (19, 0))
