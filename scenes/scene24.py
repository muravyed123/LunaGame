...
def start():
    ...
    ar1 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (28, 0))
    ar2 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (20, 1))
    door1 = Sc.Sprite(textures[6], (1765, 60), (285, 555))
    door2 = Sc.Sprite(textures[4], (2570, 65), (270, 545))
    door3 = Sc.Sprite(textures[1], (60, -40), (540, 695))
    door4 = Sc.Sprite(textures[3], (925, 55), (330, 545))
