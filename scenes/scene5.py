...
textures = ["materials/floor.png", 'materials/stairs.png', 'materials/door4.png', 'materials/evacuation.png', 'materials/window.png',
...
def start():
    ...
    stairs = Sc.Sprite(textures[1], (1485, -20), (535, 630))
    start_pos = -138
    leng = 611
    label = Sc.PlayLabel('1 ЭТАЖ', (1200, 50), (100, 0, 0), 50)
