...
textures = ["materials/floor.png", 'materials/door2.png', 'materials/evacuation.png']
...
def start():
    ...
    ar1 = Sc.Area(2945, 215, (40, 410), Sc.change_scene, (2, 1))
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (8, 0))
    door1 = Sc.Sprite(textures[1], (605, -50), (500, 700))
    door2 = Sc.Sprite(textures[1], (2080, -50), (500, 700))
    evac = Sc.Sprite(textures[2], (1455, 155), (290, 180))
