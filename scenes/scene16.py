...
def start():
    ...
    ar2 = Sc.Area(2970, 65, (40, 625), Sc.change_scene, (12, 0))
    colis1 = Sc.CollisionShape(-70, 180, (100, 510))
    door1 = Sc.Sprite(textures[1], (2340, -55), (595, 710))
    door2 = Sc.Sprite(textures[3], (160, 35), (335, 565))
    door3 = Sc.Sprite(textures[5], (1710, 50), (305, 560))
    door4 = Sc.Sprite(textures[6], (940, 40), (325, 580))
