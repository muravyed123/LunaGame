...
def start():
    ...
    ar1 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (48, 0))
    ar2 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (40, 1))
    door1 = Sc.Sprite(textures[3], (1730, 50), (320, 555))
    door2 = Sc.Sprite(textures[6], (2570, 65), (270, 545))
    door3 = Sc.Sprite(textures[2], (240, 10), (360, 625))
    door4 = Sc.Sprite(textures[7], (1030, 55), (260, 545))
    evac = Sc.Sprite(textures[8], (670, 100), (265, 205))
