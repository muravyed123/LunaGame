...
def start():
    ...
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (32, 1))
    ar3 = Sc.Area(2930, 65, (40, 625), Sc.change_scene, (34, 0))
    door1 = Sc.Sprite(textures[2], (2400, 40), (315, 590))
    door2 = Sc.Sprite(textures[4], (245, 95), (250, 510))
    door3 = Sc.Sprite(textures[1], (1590, -10), (535, 655))
    door4 = Sc.Sprite(textures[8], (905, 65), (320, 560))
