...
def start():
    ...
    ar2 = Sc.Area(10, 65, (40, 625), Sc.change_scene, (31, 1))
    colis1 = Sc.CollisionShape(2970, 180, (100, 510))
    door1 = Sc.Sprite(textures[2], (1645, 20), (310, 615))
    door2 = Sc.Sprite(textures[5], (2360, 60), (285, 555))
    door3 = Sc.Sprite(textures[6], (115, 40), (305, 570))
    door4 = Sc.Sprite(textures[7], (930, 55), (270, 550))
